...
public class EnquiryController {
    ...
    public @ResponseBody
    void sendEnquiryForVisit(@RequestParam("id") long id, Principal principal) {
    ...
    public @ResponseBody
    void acceptEnquiry(@RequestParam("id") long id) {
    ...
    public @ResponseBody
    void declineEnquiry(@RequestParam("id") long id) {
    ...
    public @ResponseBody
    void reopenEnquiry(@RequestParam("id") long id) {
    ...
    public @ResponseBody
    void rateUser(Principal principal,
                    @RequestParam("rate") long id,
    ...
    public @ResponseBody
    int ratingFor(Principal principal, @RequestParam("user") long id) {
