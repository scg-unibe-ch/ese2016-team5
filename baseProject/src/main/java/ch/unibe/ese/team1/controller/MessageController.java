...
public class MessageController {
    ...
    public @ResponseBody
    Iterable<Message> getInbox(Principal principal) {
    ...
    public @ResponseBody
    Iterable<Message> getSent(Principal principal) {
    ...
    public @ResponseBody
    Message getMessage(@RequestParam Long id) {
    ...
    public @ResponseBody
    void readMessage(@RequestParam("id") long id) {
    ...
    public @ResponseBody
    int unread(Principal principal) {
    ...
    public @ResponseBody
    void sendMessage(@RequestParam String subject,
